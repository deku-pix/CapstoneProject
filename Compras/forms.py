...
class CompraForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'metodo': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Inserte metodo de compra.', 'style': 'margin-top:10px'}),
            ...
            'objeto': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'De ser delegada mencione el tipo.', 'style': 'margin-top:10px'}),
            ...
            'fondos': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Tipo de fondo.', 'style': 'margin-top:10px'}),
            'descripcion': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ofrezca una descripcion.', 'style': 'margin-top:10px'}),
            ...
            'asignacion': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Inserte tipo de asignacion.', 'style': 'margin-top:10px'}),
